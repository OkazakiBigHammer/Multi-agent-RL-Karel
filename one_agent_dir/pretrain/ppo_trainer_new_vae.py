...
class PPOModel(object):
    def __init__(self, device, config, dummy_envs, dsl, logger, writer, global_logs, verbose):
        ...
        assert config['mdp_type'] in ['ProgramEnv_option_new_vae', 'ProgramEnv_option_new_vae_v2' ,'ProgramEnv_option_new_vae_v2_reconstruct', 'ProgramEnv_option_new_vae_v2_key2door', 'ProgramEnv_option_new_vae_v2_key2door_fixed']
        ...
        self.program_vae.load_state_dict(params[0], strict=False)
