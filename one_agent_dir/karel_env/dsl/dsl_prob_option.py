...
from dsl_base_option import DSLBase, MIN_INT, MAX_INT, INT_PREFIX
from dsl_data_option import DSLData


class DSLProb_option(DSLBase, DSLData):
    t_ignore = ' \t\n'
    ...
    #prob_stmt = [0.15, 0.03, 0.2, 0.3, 0.18, 0.14]
