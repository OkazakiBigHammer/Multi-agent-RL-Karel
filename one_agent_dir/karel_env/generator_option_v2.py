...
def main():
    ...
    parser.add_argument('--dir_name', type=str, default='karel_dataset_option_L18_1m_cover_branch')
    ...
    parser.add_argument('--max_program_length', type=int, default=18)
    ...
    args.dir_name = os.path.join('datasets_options_L18_1m_cover_branch/', args.dir_name)
    check_path('datasets_options_L18_1m_cover_branch')
